...
public class QuizController  {
    ...
    private int selectedQuizIndex = random.nextInt(5);
    ...
    private void loadQuizSets() {
        // Mỗi QuizSet bao gồm một danh sách các câu hỏi, các lựa chọn và câu trả lời đúng
        //Tạo bộ 1: random
        ...
        /**
         * Tạo bộ 3: văn học, khoa học, địa lý và nghệ thuật
         */
        ...
        /**
         * Tạo bộ 4: ẩm thực, công nghệ thông tin,
         * khoa học vật lý, sinh học, địa lý, văn học,
         * kinh tế, đến động vật học và địa danh nổi tiếng
         */
        ...
        /**
         * Tạo bộ 5: hóa học, địa lý, lịch sử, nghệ thuật,
        ...
        // Hiển thị bộ câu hỏi random(selected)
    ...
    boolean checkAnswer(String answer) {
        List<String> correctAnswers = quizSets.get(selectedQuizIndex).getCorrectAnswers();
        return answer.equals(correctAnswers.get(currentQuestionIndex));
    }
